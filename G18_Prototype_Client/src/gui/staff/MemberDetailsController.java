...
/**
 * Controller for the specific Member Details screen.
 * <p>
 * This screen is opened when a staff member selects a user from the management list.
 * It displays:
 * 1. Static personal information (passed via {@link #initData(User)}).
 * 2. Dynamic order history (loaded from {@link ChatClient#listOfOrders}).
 * </p>
 */
public class MemberDetailsController implements Initializable {
    ...
    @FXML private TableView<Order> tblHistory;
    ...
    @FXML private TableColumn<Order, String> colVisitType; 
     ...
     * It configures the table columns and loads the data from the client's memory.
     * </p>
     *
    ...
    /**
     * Receives the selected User object from the previous screen (MemberManagement).
     * Updates the UI labels with the user's personal information.
     *
    ...
    /**
     * Configures the table columns to map to the {@link Order} properties.
     * Includes custom logic for the 'Visit Type' column.
     */
