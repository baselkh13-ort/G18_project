 ...
 * <ul>
 * <li>Add new tables to the restaurant layout.</li>
 * <li>Update the capacity of existing tables.</li>
 * <li>Remove tables from the restaurant.</li>
 * </ul>
 * <b>Note:</b> According to the "Best Fit" algorithm, 
 * any modification here triggers a server-side inventory check. If the capacity decreases 
 * and future reservations cannot be accommodated, the server is responsible for 
 * canceling those orders and notifying the customers.
 * </p>
 */
public class ManageTablesController implements Initializable {
    ...
    @FXML private TextField txtTableId;
     ...
     * <p>
     * Sets up the table columns, loads initial data from ChatClient memory,
     * and adds a listener to the table selection to populate input fields automatically.
     * </p>
     */
    @Override
    ...
    /**
     * Configures the TableView columns to map to the {@link Table} entity properties.
     */
    ...
    void clickAdd(ActionEvent event) {
        try {
            ...
            // Note: If automatic refresh via ChatClient is implemented, remove this line:
            refreshData(); 
     ...
     * <p>
     * Sends an {@code UPDATE_TABLE} request. The server will check if reducing capacity
     * conflicts with existing future reservations.
     * </p>
     * @param event The action event.
     */
    @FXML
     ...
     * Includes client-side validation to prevent deleting occupied tables.
     * </p>
     * @param event The action event.
     */
    @FXML
    void clickRemove(ActionEvent event) {
        ...
        // Note: Ideally, the table list should refresh automatically via the ChatClient callback
        refreshData();
    }
