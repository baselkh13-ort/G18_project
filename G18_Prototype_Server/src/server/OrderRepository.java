...
public class OrderRepository {
    ...
    public boolean processPayment(int orderId, double finalPrice) {
        ...
        int tableId = (o != null && o.getAssignedTableId() != null) ? o.getAssignedTableId() : -1;
    ...
    public boolean isTableAvailableNow(int requiredCapacity) {
        ...
        String sqlTotal = "SELECT COUNT(*) FROM `tables` WHERE seats >= ?";
        String sqlOccupied = "SELECT COUNT(*) FROM `tables` WHERE seats >= ? AND status = 'OCCUPIED'";
    ...
    /**
     * Scans for orders due in 2 hours and prints a simulation reminder to console.
     */
    ...
    /**
     * Scans for seated tables exceeding the 2-hour limit and simulates sending a bill.
     */
