...
/**
 * Represents a order/reservation in the Bistro system.
 * <p>
 * An Order includes details about the scheduled time, number of guests, contact info,
 * and the current status of the reservation.
 * </p>
 * <p>
 * <b>Important Logic Note:</b> An order reserves a spot based on restaurant capacity, 
 * not a specific table ID at the booking stage. The specific table is assigned only upon arrival.
 * </p>
 */
public class Order implements Serializable {
    ...
    /** * The code required for the customer to enter the restaurant. 
     * Generated by the server upon approval. 
     */
    private int confirmationCode;
    
    private int memberId;  /** The ID of the registered member. 0 if the customer is casual (guest). */
...
Full Constructor - Used primarily by the Server when retrieving existing data from the DB.
    ...
    public Order(int orderNumber, Timestamp orderDate, int numberOfGuests, int confirmationCode, 
                 int memberId, Timestamp dateOfPlacingOrder) {
     ...
     * <p>
     * Initializes the order with 'PENDING' status. 
     * The {@code confirmationCode} and {@code orderNumber} are set to 0, 
     * as they will be generated by the server only after availability check (Best Fit algorithm).
     * </p>
     *
